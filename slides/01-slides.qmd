...
1.  Understand why measurement is important to psychological research.
2.  Understand the special problems that cultural research presents.
3.  Understand why measurement test are not enough.

**Key Concepts**

1.  Measurement
2.  Validity (in measurement)
3.  Confounding (in estimation)
...
-   Week 4: Dealing with Data Factor Analysis (Inkuk Kim) - assessing use multiple items to assess "happiness"
...
Week 8: Causal inference: Target Trial Emulation (Joseph (Joseph Bulbulia). How to emulate an experiment with observational data and how to identify the modification of effects by cultural groups.
