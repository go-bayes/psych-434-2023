...
\node [rectangle, draw=white] (K1) at (2, 0) {t1/K};
\node [rectangle, draw=black] (A1) at (4, -1) {t1/A};
\node [rectangle, draw=white] (Y2) at (6, 0) {t2/Y};

\draw [-latex, draw=black] (L0) to (K1);
\draw [-latex, bend left, draw=black] (L0) to (Y2);
\draw [-latex, draw=black] (K1) to (A1);
\draw [-latex, draw=red, dashed] (K1) to (Y2);
...
## Structural interpretation of a latent factor




## TO DO STILL: Measurement Error
