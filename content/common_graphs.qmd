...
\node [rectangle, draw=white] (Y) at (8, 0) {t1*-Y};
...
\node [rectangle, draw=black] (L2) at (8, 0) {t2e-L};
\node [rectangle, draw=white] (A2) at (10, 0) {t2e-A};
\node [rectangle, draw=black] (Y3) at (12, 0) {t3-Y};
